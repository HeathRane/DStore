...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="txtCustomerId" runat="server" Text="Customer Id  " height="19px" width="130px"></asp:Label>
        <asp:TextBox ID="TextBox1" runat="server" style="margin-left: 14px" Width="253px" height="22px" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
        <p>
